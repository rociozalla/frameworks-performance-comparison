package com.rociozalla.springbootmicroservices.controller;


import com.rociozalla.springbootmicroservices.service.ArithmeticService;
...
public class ArithmeticController {
    ...
    public boolean getIsPrime(@PathVariable("number") int number) {
